...
let Penjualan = class Penjualan extends Transaksi_1.Transaksi {
};
__decorate([
    torm.Column(),
    __metadata("design:type", Number)
], Penjualan.prototype, "jumlah", void 0);
__decorate([
    torm.Column({ type: 'int', nullable: false }),
    __metadata("design:type", Number)
], Penjualan.prototype, "idItem", void 0);
__decorate([
    torm.ManyToOne(type => Item_1.Item, { onDelete: 'CASCADE' }),
    torm.JoinColumn({ name: 'idItem' }),
    __metadata("design:type", Item_1.Item)
], Penjualan.prototype, "item", void 0);
__decorate([
    torm.Column('int'),
    __metadata("design:type", Number)
